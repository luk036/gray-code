...
Welcome to `gray-code` contributor's guide.
...
If you experience bugs or general issues with `gray-code`, please have a look
...
You can help improve `gray-code` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`gray-code` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `gray-code`'s files. While this mechanism can
...
```
conda create -n gray-code python=3 six virtualenv pytest pytest-cov
conda activate gray-code
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/gray-code.git
   cd gray-code
   ```
...
5. Install [pre-commit]:
   ...
   `gray-code` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/gray-code
[issue tracker]: https://github.com/<USERNAME>/gray-code/issues
